...
class GeneticAlgorithm():
    def __init__(self, epochs = 100, mutation_rate=0.05, generation_size=10, success_ratio=0.2, world_function=designed_worlds.random_500, ckpt_folder=None):
    ...
    def sex(self, parent1, parent2):
        ...
        child_world = self.world_function()
